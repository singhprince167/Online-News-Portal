    ...
    <div class="block-content">
      ...
      <div class="single-post-box">
        <div class="title-post">
          <h1><?php echo $singleData->title ?>. </h1>
          <ul class="post-tags">
            <li><i class="fa fa-clock-o"></i><?php echo $singleData->postdatereg ?></li>
            <li><i class="fa fa-user"></i>by <a href="#"><?php echo $singleData->rname?></a></li>
        ...
        <div class="post-gallery"> <img src="<?php echo base_url() ?>Admin/images/post/<?php echo $singleData->image ?>" height="350" width="600" alt=""> <span class="image-caption"><?php echo $singleData->title ?></span> </div>
        <div class="post-content" id="showlessdata">
          <?php 
                                  $string = $singleData->description;
       ...
       <div class="post-content" id="getmoredata" style="display:none">
        ...
        <div class="center-button" id="loadmorebtn">
		 ...
		 <a href="<?php echo site_url()?>/singlepostc/like/<?php echo $singleData->rid?>/<?php echo $singleData->cid?>" style="text-decoration:none" name="like"  onclick="hidelike()"><i class="fa fa-thumbs-o-up " ></i>
		 </a> <?php echo $like ; ?>	&nbsp;&nbsp;&nbsp;
		 <a href="<?php echo site_url()?>/singlepostc/dislike/<?php echo $singleData->rid?>/<?php echo $singleData->cid?>" name="dislike"  onclick="hidelike()"><i class="fa fa-thumbs-o-down"></i>
		 </a>
		 <?php  echo  $dislike; ?>	
		 <?php }else{?>
