		...
		<div class="row">
			...
			<div class="boxs-body">
			 <div class="form-group">
               <a href="<?php echo site_url(); ?>/Reportpostc/postins" class="btn btn-raised btn-info"><i class="glyphicon glyphicon-plus"></i> Add Post</a>
   <form method="post" action="<?php echo site_url()?>/Reportpostc/muldel/">
                ...
                <label for="filter" style="padding-top: 5px">Search:</label>
		           ...
		           <input type="checkbox" name="chk[]"  value="<?php echo $row->rid;?>"> </label>
                                    ...
                                    <td> <a href="<?php echo site_url()?>/Reportpostc/status/<?php echo $row->rid ?>" class="<?php if($row->rpstatus=="Active"){?>btn btn-raised btn-success btn-sm"<?php }else {?>  btn btn-raised btn-primary btn-sm <?php }?>style="text-decoration:none;">
	
									<?php echo $row->rpstatus;?></a> </td>
       <td><a href="<?php echo site_url()?>/Reportpostc/postdel/<?php echo $row->rid;?>"><i class="fa fa-trash-o"  style='color:#F00;'></i></a>|
           <a href="<?php echo site_url()?>/Reportpostc/postedit/<?php echo $row->rid;?>"><i class="fa fa-edit"></i></a>
     </td><?php
									 }?>
                                     </tr>
                                    </tbody>
