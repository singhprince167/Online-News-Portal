      ...
      <div class="col-md-4 col-sm-12 col-xs-12">
                        <section class="boxs user_widget">
                            ...
                            <a  data-toggle="modal" data-target="#myModal">
                             <img class="img-circle" src="<?php echo base_url()?>images/<?php echo $get->repid."/".$get->rimage ?>"  alt="User Avatar"></a></div>
                            <div class="uw_footer">
            ...
            <div class="boxs-body p-0">
              <div role="tabpanel">
                <ul class="nav nav-tabs tabs-dark-t" role="tablist">
                  <li role="presentation" > <a href="<?php echo site_url()?>/Reporterregc/home" role="tab" data-toggle="">All News</a> </li>
                  ...
                  <li role="presentation" > <a href="<?php echo site_url()?>/Reportpostc/Tech/technology" role="tab" data-toggle="">Techology</a> </li>
					<li role="presentation" class="active"> <a href="#setting" role="tab" data-toggle="">Lifestyle</a> </li>
                ...
                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="mypost">
                    <div class="wrap-reset">
                      ...
                      <hr>
                        <div class="post-box">
                          <div class="post-img"> <img src="<?php echo base_url() ?>images/post/<?php echo $data->image ?>" class="img-responsive" height="300px" width="400px" alt /> </div>
...
<form method="post" action="<?php echo site_url()?>/Reporterregc/setpic/"enctype="multipart/form-data">       
